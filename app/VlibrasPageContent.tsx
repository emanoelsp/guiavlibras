      ...
      <section className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <Alert>
            ...
            <AlertDescription>
              Como o Next.js possui duas arquiteturas principais (App Router e Pages Router), forneceremos o passo a
              passo para ambas.
            </AlertDescription>
          </Alert>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    ...
                    <code className="text-sm bg-muted px-1 py-0.5 rounded">/components/VlibrasWidget.tsx</code>. Este
                    será um Componente Cliente, pois interage com o DOM e a window do navegador.
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  ...
                  <div className="mt-4 space-y-2">
                    <div className="flex items-start gap-2">
                      ...
                      <p className="text-sm text-muted-foreground">
                        O componente usa <code className="bg-muted px-1 py-0.5 rounded">"use client"</code> para
                    ...
                    <div className="flex items-start gap-2">
                      <CheckCircle2 className="h-5 w-5 text-green-600 mt-0.5 flex-shrink-0" />
                      <p className="text-sm text-muted-foreground">
                        O widget é inicializado automaticamente após o carregamento do script
                      </p>
                    </div>
                  </div>
                </CardContent>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    ...
                    adicione o componente Script e o div do VLIBRAS.
                  </CardDescription>
                </CardHeader>
                <CardContent>
          ...
          <Card className="border-blue-200 bg-blue-50/50 dark:border-blue-900 dark:bg-blue-950/20">
            <CardHeader>
              <div className="flex items-center gap-2">
                ...
                <CardTitle className="text-blue-900 dark:text-blue-100">Dica para TypeScript</CardTitle>
              </div>
              <CardDescription className="text-blue-800 dark:text-blue-200">
                Se você estiver usando TypeScript, o editor poderá reclamar que VLibras não existe no objeto window.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <p className="text-sm text-blue-900 dark:text-blue-100">
                Para corrigir isso, crie um arquivo de definição de tipos:
              </p>
              <CodeBlock code={typeScriptCode} />
              <p className="text-sm text-blue-900 dark:text-blue-100">
                Isso informa ao TypeScript que{" "}
                <code className="bg-blue-100 dark:bg-blue-900 px-1 py-0.5 rounded">window.VLibras</code> pode existir,
          ...
          <Card className="border-green-200 bg-green-50/50 dark:border-green-900 dark:bg-green-950/20">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex items-start gap-3">
                <CheckCircle2 className="h-5 w-5 text-green-600 dark:text-green-400 mt-0.5 flex-shrink-0" />
                <div>
                  <p className="font-medium text-green-900 dark:text-green-100">Personalize o widget</p>
                  <p className="text-sm text-green-800 dark:text-green-200">
                    Consulte a documentação oficial do VLIBRAS para opções de personalização
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-3">
